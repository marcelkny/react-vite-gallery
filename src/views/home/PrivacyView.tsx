import PrivacyContact from "../../components/text/PrivacyContact";

export default function PrivacyView() {
    return (
        <div className="bg-gray-700 px-2 text-gray-200">
            <div className="w-full md:w-3/4 xl:w-1/2 mx-auto">
                <h1 className="text-3xl text-center font-semibold pb-2">Datenschutzerklärung</h1>

                <p className="mb-4">
                    Ich freue mich sehr über Ihr Interesse an diesem Projekt. Diese Webseite wird von einer Privatperson für ein Musikprojekt verwendet. Weitere Details zur verantwortlichen Person finden Sie entweder hier (weiter unten im Text) oder im <a className="font-semibold hover:cursor-pointer" href="/imprint">Impressum</a>. Die Person ist für beide Fälle identisch.
                    Immer wenn im folgenden Text vom "Seitenbetreiber" die Rede ist, wird auf diese Person Bezug genommen.
                </p>

                <p className="mb-4">
                    Datenschutz hat für mich einen besonders hohen Stellenwert. Eine Nutzung dieser Internetseiten ist grundsätzlich ohne jede Angabe personenbezogener
                ...
                <p className="mb-4">
                    ...
                    Person, erfolgt stets im Einklang mit der Datenschutz-Grundverordnung und in Übereinstimmung mit den für den Seitenbetreiber
                ...
                <p className="mb-4">
                    der Seitenbetreiber hat als für die Verarbeitung Verantwortlicher zahlreiche technische und organisatorische Maßnahmen umgesetzt, um
                ...
                <p className="mb-4">
                    Die Datenschutzerklärung des Seitenbetreibers beruht auf den Begrifflichkeiten, die durch den Europäischen Richtlinien- und
                ...
                <ul style={{listStyle: "none"}} className="mb-8">
                    <li>
                        <h4 className="">a) personenbezogene Daten</h4>
                        <p className="pl-4 mb-2">
                            ...
                            zu einem oder mehreren besonderen Merkmalen, die Ausdruck der physischen, physiologischen, genetischen, psychischen,
                    ...
                    <li>
                        ...
                        <p className="pl-4 mb-2">
                            ...
                            Zusammenhang mit personenbezogenen Daten wie das Erheben, das Erfassen, die Organisation, das Ordnen, die Speicherung, die Anpassung
                            oder Veränderung, das Auslesen, das Abfragen, die Verwendung, die Offenlegung durch Übermittlung, Verbreitung oder eine andere Form
                    ...
                    <li>
                        ...
                        <p className="pl-4 mb-2">
                            ...
                            um Aspekte bezüglich Arbeitsleistung, wirtschaftlicher Lage, Gesundheit, persönlicher Vorlieben, Interessen, Zuverlässigkeit,
                    ...
                    <li>
                        ...
                        <p className="pl-4 mb-2">
                            ...
                            entscheidet. Sind die Zwecke und Mittel dieser Verarbeitung durch das Unionsrecht oder das Recht der Mitgliedstaaten vorgegeben, so
                            kann der Verantwortliche beziehungsweise können die bestimmten Kriterien seiner Benennung nach dem Unionsrecht oder dem Recht der
                    ...
                    <li>
                        ...
                        <p className="pl-4 mb-2">
                            Auftragsverarbeiter ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die personenbezogene Daten
                ...
                <p className="mb-4">
                    Die Internetseite des Seitenbetreibers erfasst mit jedem Aufruf der Internetseite durch eine betroffene Person oder ein
                ...
                <p className="mb-4">
                    Bei der Nutzung dieser allgemeinen Daten und Informationen zieht der Seitenbetreiber keine Rückschlüsse auf die betroffene Person.
                    Diese Informationen werden vielmehr benötigt, um (1) die Inhalte unserer Internetseite korrekt auszuliefern, (2) die Inhalte unserer
                    ...
                    Strafverfolgung notwendigen Informationen bereitzustellen. Diese anonym erhobenen Daten und Informationen werden durch den Seitenbetreiber daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die Datensicherheit in unserem
                    ...
                    anonymen Daten der Server-Logfiles werden getrennt von allen durch eine betroffene Person angegebenen personenbezogenen Daten gespeichert.
                </p>
                ...
                <ul style={{listStyle: "none"}}  className="mb-4">
                    ...
                    <li>
                        ...
                        <ul style={{listStyle: "none"}} className="pl-4">
                            <li className="list-disc ml-4 mb-2">die Verarbeitungszwecke</li>
                            <li className="list-disc ml-4 mb-2">die Kategorien personenbezogener Daten, die verarbeitet werden</li>
                            ...
                            <li className="list-disc ml-4 mb-2">das Bestehen eines Beschwerderechts bei einer Aufsichtsbehörde</li>
                            <li className="list-disc ml-4 mb-2">
                        ...
                        <p className="mb-4">
                            Möchte eine betroffene Person dieses Auskunftsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit an einen Mitarbeiter des für
                    ...
                    <li>
                        ...
                        <p className="mb-4">
                            Möchte eine betroffene Person dieses Berichtigungsrecht in Anspruch nehmen, kann sie sich hierzu jederzeit an einen Mitarbeiter des
                    ...
                    <li className="list-disc ml-4 mb-2">
                        ...
                        <ul style={{listStyle: "none"}}>
                            ...
                            <li className="list-disc ml-4 mb-2">Die personenbezogenen Daten wurden unrechtmäßig verarbeitet.</li>
                            <li className="list-disc ml-4 mb-2">
                        ...
                        <p className="mb-4">
                            Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von personenbezogenen Daten, die beim Seitenbetreiber gespeichert sind, veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
                            Verarbeitung Verantwortlichen wenden. Der Seitenbetreiber wird veranlassen, dass dem Löschverlangen
                            unverzüglich nachgekommen wird.
                        </p>

                        <p className="mb-4">
                            Wurden die personenbezogenen Daten des Seitenbetreibers öffentlich gemacht und ist er als Verantwortlicher
                            gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen Daten verpflichtet, so trifft der Seitenbetreiber unter
                            Berücksichtigung der verfügbaren Technologie und der Implementierungskosten angemessene Maßnahmen, auch technischer Art, um andere
                            für die Datenverarbeitung Verantwortliche, welche die veröffentlichten personenbezogenen Daten verarbeiten, darüber in Kenntnis zu
                            setzen, dass die betroffene Person von diesen anderen für die Datenverarbeitung Verantwortlichen die Löschung sämtlicher Links zu
                            diesen personenbezogenen Daten oder von Kopien oder Replikationen dieser personenbezogenen Daten verlangt hat, soweit die
                            Verarbeitung nicht erforderlich ist. Der Seitenbetreiber wird im Einzelfall das Notwendige veranlassen.
                        </p>
                    </li>
                    <li className="list-disc ml-4 mb-2">
                        ...
                        <p className="mb-4">
                            ...
                            die beim Seitenbetreiber gespeichert sind, verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für
                            die Verarbeitung Verantwortlichen wenden. Der Seitenbetreiber wird die Einschränkung der Verarbeitung
                            veranlassen.
                        </p>
                    </li>
                    <li className="list-disc ml-4 mb-2">
                        ...
                        <p className="mb-4">
                            ...
                            Daten einem anderen Verantwortlichen ohne Behinderung durch den Verantwortlichen, dem die personenbezogenen Daten bereitgestellt
                            wurden, zu übermitteln, sofern die Verarbeitung auf der Einwilligung gemäß Art. 6 Abs. 1 Buchstabe a DS-GVO oder Art. 9 Abs. 2
                        ...
                        <p className="mb-4">
                            Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person jederzeit an den Seitenbetreiber wenden.
                        </p>
                    </li>
                    <li className="list-disc ml-4 mb-2">
                        ...
                        <p className="mb-4">
                            der Seitenbetreiber verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr, es sei denn, wir können
                        ...
                        <p className="mb-4">
                            Verarbeitet der Seitenbetreiber personenbezogene Daten, um Direktwerbung zu betreiben, so hat die betroffene Person das
                            Recht, jederzeit Widerspruch gegen die Verarbeitung der personenbezogenen Daten zum Zwecke derartiger Werbung einzulegen. Dies gilt
                            auch für das Profiling, soweit es mit solcher Direktwerbung in Verbindung steht. Widerspricht die betroffene Person gegenüber dem Seitenbetreiber der Verarbeitung für Zwecke der Direktwerbung, so wird der Seitenbetreiber die personenbezogenen Daten
                        ...
                        <p className="mb-4">
                            ...
                            Verarbeitung personenbezogener Daten, des Seitenbetreibers zu wissenschaftlichen oder historischen Forschungszwecken
                        ...
                        <p className="mb-4">
                            Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt an den Seitenbetreiber wenden. Der betroffenen Person steht es ferner frei, im Zusammenhang mit der Nutzung von Diensten der
                    ...
                    <li className="list-disc ml-4 mb-2">
                        ...
                        <p className="mb-4">
                            ...
                            Person und dem Verantwortlichen erforderlich ist, oder (2) aufgrund von Rechtsvorschriften der Union oder der Mitgliedstaaten, denen
                            der Verantwortliche unterliegt, zulässig ist und diese Rechtsvorschriften angemessene Maßnahmen zur Wahrung der Rechte und
                        ...
                        <p className="mb-4">
                            ...
                            der Seitenbetreiber angemessene Maßnahmen, um die Rechte und Freiheiten sowie die berechtigten Interessen der betroffenen Person
                            zu wahren, wozu mindestens das Recht auf Erwirkung des Eingreifens einer Person seitens des Verantwortlichen, auf Darlegung des
                            eigenen Standpunkts und auf Anfechtung der Entscheidung gehört.
                        </p>

                        <p className="mb-4">
                            Möchte die betroffene Person Rechte mit Bezug auf automatisierte Entscheidungen geltend machen, kann sie sich hierzu jederzeit an
                ...
                <p>
                    ...
                    Interesses unseres Unternehmens oder eines Dritten erforderlich ist, sofern die Interessen, Grundrechte und Grundfreiheiten des Betroffenen
                    nicht überwiegen. Solche Verarbeitungsvorgänge sind uns insbesondere deshalb gestattet, weil sie durch den Europäischen Gesetzgeber
                    besonders erwähnt wurden. Er vertrat insoweit die Auffassung, dass ein berechtigtes Interesse anzunehmen sein könnte, wenn die betroffene
                ...
                <p>
                    ...
                    werden müssen. Die betroffene Person ist beispielsweise verpflichtet uns personenbezogene Daten bereitzustellen, wenn unser Unternehmen mit
                    ihr einen Vertrag abschließt. Eine Nichtbereitstellung der personenbezogenen Daten hätte zur Folge, dass der Vertrag mit dem Betroffenen
                    nicht geschlossen werden könnte. Vor einer Bereitstellung personenbezogener Daten durch den Betroffenen muss sich der Betroffene an einen
                    unserer Mitarbeiter wenden. Unser Mitarbeiter klärt den Betroffenen einzelfallbezogen darüber auf, ob die Bereitstellung der
                ...
                <p>
                    ...
                    <a href="https://dg-datenschutz.de/datenschutz-dienstleistungen/externer-datenschutzbeauftragter/" rel="nofollow">
                        Externer Datenschutzbeauftragter Ingolstadt
                    </a>{" "}
                    tätig ist, in Kooperation mit dem{" "}
                    <a href="https://www.wbs.legal/it-recht/datenschutzrecht" rel="nofollow">
