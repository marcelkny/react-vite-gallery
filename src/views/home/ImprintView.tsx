    ...
    return (
        <div className="px-2 text-gray-200">
            <div className="w-full md:w-3/4 xl:w-1/2 mx-auto">
                <h1 className="text-3xl text-center font-semibold pb-6">Impressum</h1>
                <br />
                <div>
                    ...
                    jedoch keine Gewähr übernehmen. Als Diensteanbieter sind wir gemäß § 7 Abs.1 DDG für eigene Inhalte auf diesen Seiten nach den allgemeinen
                    Gesetzen verantwortlich. Nach §§ 8 bis 10 DDG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde
